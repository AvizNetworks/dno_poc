...
export function AWSDashboard() {
  ...
  // Mock data - will be replaced with AWS CLI data
        ...
        <div className="p-6 h-full flex flex-col">
          ...
          <Tabs value={activeView} onValueChange={setActiveView} className="flex-1 flex flex-col">
            ...
            <TabsContent value="config" className="flex-1 overflow-auto">
              <Tabs value={configView} onValueChange={setConfigView} className="space-y-4">
                <TabsList className="grid w-full max-w-md grid-cols-2">
                  <TabsTrigger value="deploy">Deploy ACN</TabsTrigger>
